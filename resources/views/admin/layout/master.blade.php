...
<body>
    ...
    <div class="header">
        ...
        <div class="header-right">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <div class="notification-list mx-h-350 customscroll">
                            <ul>
                                <li>
                                    <a href="#">
                                        <img src="{{url('/')}}/assets/vendors/images/img.jpg" alt="" />
                                        <h3>John Doe</h3>
                                        <p>
                                ...
                                <li>
                                    <a href="#">
                                        <img src="{{url('/')}}/assets/vendors/images/photo1.jpg" alt="" />
                                        <h3>Lea R. Frith</h3>
                                        <p>
                                            Lorem ipsum dolor sit amet, consectetur adipisicing
                                            elit, sed...
                                ...
                                <li>
                                    <a href="#">
                                        <img src="{{url('/')}}/assets/vendors/images/photo2.jpg" alt="" />
                                ...
                                <li>
                                    <a href="#">
                                        <img src="{{url('/')}}/assets/vendors/images/photo3.jpg" alt="" />
                                        <h3>John Doe</h3>
                                        <p>
                                            Lorem ipsum dolor sit amet, consectetur adipisicing
                                            elit, sed...
                                ...
                                <li>
                                    <a href="#">
                                        <img src="{{url('/')}}/assets/vendors/images/photo4.jpg" alt="" />
            ...
            <div class="github-link">
                <a href="https://github.com/dropways/deskapp" target="_blank"><img src="{{url('/')}}/assets/vendors/images/github.svg" alt="" /></a>
            </div>
        </div>
    </div>
        ...
        <div class="menu-block customscroll">
            <div class="sidebar-menu">
                <ul id="accordion-menu">
                    ...
                    <li>
                        <a href="javascript:;" class="dropdown-toggle">
                            <span class="micon bi bi-file-pdf"></span><span class="mtext">Administration</span>
                        </a>
                        <ul class="submenu">
                    ...
                    <li>
                        <a href="javascript:;" class="dropdown-toggle">
                            <span class="micon bi bi-file-pdf"></span><span class="mtext">Profile</span>
                        </a>
                        <ul class="submenu">
    ...
    <script src="{{url('/')}}/assets/js/permission.js"></script>
